...
| 2026-07-08 | @haaslogan1 | Profile | **Critical:** iPhone profile photo rotated 90° CCW on upload | @madisonmitchellusa took a profile photo on iPhone and uploaded it. The image was displayed rotated 90 degrees counter-clockwise. Expected: respect EXIF orientation (or normalize on upload) so the photo appears upright. |
