...
export default function GamePlayPage() {
  ...
  const showInactivityModal = state.inactivity_warning && !inactivityDismissed && !isSpectator;
  ...
  async function onContinuePlaying() {

    try {

      const next = await ackInactivity(gameId);
      ...
      setError(e instanceof Error ? e.message : "Could not acknowledge inactivity");
    ...
    <div>
      ...
      {showInactivityModal && (
        ...
        <div className="feedback-modal-overlay" role="presentation">
          ...
          <div className="feedback-modal" role="dialog" aria-labelledby="inactivity-modal-title" aria-modal="true">
            ...
            <div className="btn-row">
              ...
              <button type="button" className="btn" onClick={onContinuePlaying}>Continue playing</button>

              <button type="button" className="btn secondary" onClick={onEnd}>End game</button>
